...
import { MODE, IS_DEV, STARTING_GOLD, STARTING_MANA, TICK_INTERVAL_MS, BUILDING_TIME_SECONDS, CHAT_ENABLED, TROOP_STATS, BATTLE_INTERVAL_MS, BUILDING_COSTS, FORT_ADVANTAGE_TROOPS, ENTRENCH_ADVANTAGE_PER_NEIGHBOR, ENTRENCH_MAX_NEIGHBORS, MIN_TROOPS_TO_CLAIM, DECAY_HEX_THRESHOLD, DECAY_SCALE_HEXES_PER_STEP, BUILDING_GARRISON_VALUE, UNLOCKS, HEX_RESOLUTION, WORLD_HEX_COUNT, REGION_RESOLUTION } from './config.js'
...
app.get('/api/health', (_, res) => res.json({
  ...
  building_garrison_value: BUILDING_GARRISON_VALUE,
  unlocks: UNLOCKS,
  building_costs: {
