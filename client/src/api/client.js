...
export const api = {
  ...
  getGroups: () => request('GET', '/military/groups'),
  saveGroup: (group) => request('POST', '/military/groups', group),
  deleteGroup: (id) => request('DELETE', `/military/groups/${id}`),
  marchGroup: (fromHex, toHex, groupId) => request('POST', '/military/march-group', { fromHex, toHex, groupId }),
