...
// Anyone who had the (since-removed) background music toggled on shouldn't
// keep a stale preference key around.
if (typeof localStorage !== 'undefined') localStorage.removeItem('rw_music')
